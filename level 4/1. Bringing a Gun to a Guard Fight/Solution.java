...
public class Solution{
    ...
    public static int solution(int[] dimensions, int[] your_position, int[] guard_position, int distance) {
        ...
        TreeMap<Pair, int[]> suicide = new TreeMap<>();
        TreeMap<Pair, int[]> meVisited = new TreeMap<>();
        ...
        result.add(directions(your_position, guard_position));
        queue.add(new Pair());
        meVisited.put(new Pair(), your_position);
        ...
        while(!queue.isEmpty()){
            ...
            for(int[] d: dirs){
                ...
                if(guardVisited.containsKey(next)){
                    if(!meVisited.containsKey(next)) throw new RuntimeException();
                    continue;
                }
                ...
                int[] newYourPosition = {
                        next.a == cur.a ? meVisited.get(cur)[0] :
                                next.a >= 0 ?
                        ...
                        ,
                        next.b == cur.b ? meVisited.get(cur)[1] :
                                next.b >= 0 ?
                ...
                meVisited.put(next, newYourPosition);

                Pair tres2 = directions(your_position, newYourPosition);
                if(!suicide.containsKey(tres2))
                    suicide.put(tres2, newYourPosition);

                if(disSquare(your_position, newGuardPosition) <= distance * distance){

                    Pair tres1 = directions(your_position, newGuardPosition);

                    if(suicide.containsKey(tres1) && disSquare(your_position, suicide.get(tres1)) <= disSquare(your_position, newGuardPosition))
                        continue;
    ...
    public static void main(String[] args){
        ...
        System.out.println(Gun.solution(dimensions1, your_position1, guard_position1, 4));
        // 7

        int[] dimensions2 = {300, 275};
        int[] your_position2 = {150, 150};
        int[] guard_position2 = {185, 100};
        System.out.println(Gun.solution(dimensions2, your_position2, guard_position2, 500));
        // 9

        int[] dimensions3 = {2, 5};
        int[] your_position3 = {1, 2};
        int[] guard_position3 = {1, 4};
        System.out.println(Gun.solution(dimensions3, your_position3, guard_position3, 11));
        // 25? 27?
        ...
        System.out.println(Gun.solution(dimensions4, your_position4, guard_position4, 5000));
        // 739323

        int[] dimensions5 = {23, 10};
        int[] your_position5 = {6, 4};
        int[] guard_position5 = {3, 2};
        System.out.println(Gun.solution(dimensions5, your_position5, guard_position5, 23));
        // 8
    }
}
